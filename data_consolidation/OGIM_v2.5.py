...
# -----------------------------------------------------------------------------
bottomupfolder = 'C:\\Users\\maobrien\\Environmental Defense Fund - edf.org\\Mark Omara - Infrastructure_Mapping_Project\\Bottom-Up-Infra-Inventory'
# set working directory to Bottom_Up_Infra_Inventory
os.chdir(bottomupfolder)

# get string of today's date
timestr = time.strftime("%Y-%m-%d")

# set filepath(s) where final data will be saved
integration_folder = 'OGIM_v2.5\\integrated_results\\'
final_layers = f'OGIM_v2.5\\layercreation_results_{timestr}\\'
excel_report_folder = f'OGIM_v2.5\\layercreation_results_{timestr}\\excel_reports\\'
fp_of_output_gpkg = 'OGIM_v2.5\\OGIM_v2.5.gpkg'
...
# NOTE: As of v2.5, this step is included during the Intergration of the HIFLD
# wells in the `usa_wells.py` script; doesn't need to be re-run here.
# =============================================================================
